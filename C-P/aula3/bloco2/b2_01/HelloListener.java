...
public interface HelloListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link HelloParser#bruh}.
	 * @param ctx the parse tree
	 */
	void enterBruh(HelloParser.BruhContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#bruh}.
	 * @param ctx the parse tree
	 */
	void exitBruh(HelloParser.BruhContext ctx);
	/**
